...
<?php
	$get_saleman=mysqli_query($conn, "SELECT * FROM salesmen");
	while($saleman=mysqli_fetch_array($get_saleman))
	{
		$salesman_id=$saleman['salesman_id'];
		$salesman_name=$saleman['salesman_name'];
		
		echo '<option value="'.$salesman_id.'">'.$salesman_name.'</option>';
...
<select name="truck" id="truck" onchange="get_supplier_products()" onfocus="get_supplier_products()" class="form-control">
...
if(isset($_POST['add']))
{
	$sale_array['salesman_id']=$_POST['salesman'];
